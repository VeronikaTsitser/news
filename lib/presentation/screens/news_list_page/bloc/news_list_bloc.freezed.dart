...
mixin _$NewsListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<News> listNews) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<News> listNews)? success,
...
class _$_Success implements _Success {
  const _$_Success(final List<News> listNews) : _listNews = listNews;
  ...
  @override
  String toString() {
    return 'NewsListState.success(listNews: $listNews)';
  }
...
abstract class _Success implements NewsListState {
  const factory _Success(final List<News> listNews) = _$_Success;
